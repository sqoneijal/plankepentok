...
import { DokumenSkeleton, FormInformasiUsulanSkeleton, IkuSkeleton, RencanaAnggaranBiayaSkeleton, TorSkeleton } from "@/components/loading-skeleton";
...
const Tor = lazy(() => import("@/components/usulan-kegiatan/tor/form"));
