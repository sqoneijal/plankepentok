...
export const getColumns = (): Array<ColumnDef<RowData, unknown>> => [
   columnHelper.display({
      ...
      cell: ({ row: { original } }) => (
         <>
            <LinkButton label={<SquarePen />} url={`/unit-kerja/lembaga/actions/${original.id}`} type="edit" />
            <ConfirmDialog url={`/unit-kerja/lembaga`} id={original.id as string | number} refetchKey={[["/unit-kerja/lembaga"]]} />
         </>
      ),
