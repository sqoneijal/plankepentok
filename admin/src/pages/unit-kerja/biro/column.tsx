...
export const getColumns = (): Array<ColumnDef<RowData, unknown>> => [
   columnHelper.display({
      ...
      cell: ({ row: { original } }) => (
         <>
            <LinkButton label={<SquarePen />} url={`/unit-kerja/biro/actions/${original.id}`} type="edit" />
            <ConfirmDialog url={`/unit-kerja/biro`} id={original.id as string | number} refetchKey={[["/unit-kerja/biro"]]} />
         </>
      ),
