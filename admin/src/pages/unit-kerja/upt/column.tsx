...
export const getColumns = (): Array<ColumnDef<RowData, unknown>> => [
   columnHelper.display({
      ...
      cell: ({ row: { original } }) => (
         <>
            <LinkButton label={<SquarePen />} url={`/unit-kerja/upt/actions/${original.id}`} type="edit" />
            <ConfirmDialog url={`/unit-kerja/upt`} id={original.id as string | number} refetchKey={[["/unit-kerja/upt"]]} />
         </>
      ),
