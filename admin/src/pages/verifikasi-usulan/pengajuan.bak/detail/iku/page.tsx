...
import { useIKUData, useUpdateIKUBatch } from "./init";

export default function Page() {
   const { data, isLoading, error } = useIKUData();

   const [selectedRows, setSelectedRows] = useState<Set<string>>(new Set());
   const [selectedStatus, setSelectedStatus] = useState<string>("");

   const updateIKUBatch = useUpdateIKUBatch();
            ...
            <div className="row mb-4">
               ...
               <div className="col-12 col-md-2">
                  <Button
                     ...
                     size="sm"
                     disabled={updateIKUBatch.isPending || !selectedStatus}>
                     {updateIKUBatch.isPending ? btn_loading() : "Simpan"}
                  </Button>
               </div>
            </div>
         )}
