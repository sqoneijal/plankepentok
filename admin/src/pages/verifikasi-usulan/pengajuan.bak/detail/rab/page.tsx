...
import { useRabData, useUpdateRabBatch } from "./init";
...
export default function Page() {
   ...
   const updateRabBatch = useUpdateRabBatch();
            ...
            <div className="row mb-4">
               ...
               <div className="col-12 col-md-2">
                  <Button
                     ...
                     size="sm"
                     disabled={updateRabBatch.isPending || !selectedStatus}>
                     {updateRabBatch.isPending ? btn_loading() : "Simpan"}
                  </Button>
               </div>
            </div>
         )}
