...
import type { ApiResponse, FormData } from "@/types/init";
import { useState } from "react";
import { toast } from "sonner";

export default function UsulanKegiatan({ results, endpoint, id_usulan }: Readonly<{ results: FormData; endpoint: string; id_usulan: string }>) {
