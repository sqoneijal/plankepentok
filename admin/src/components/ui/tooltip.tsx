   ...
   return (
      <TooltipPrimitive.Portal>
         <TooltipPrimitive.Content
            ...
            className={cn(
               "z-50 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg",
               "whitespace-pre-line break-normal text-justify leading-relaxed",
               "rounded-md bg-primary px-3 py-2 text-sm text-primary-foreground shadow-lg",
